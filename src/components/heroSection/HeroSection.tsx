...
export function ConnectButton() {
    ...
    return (
        <div className="w-full py-6 px-4  z-10 flex flex-col sm:flex-col md:flex-row lg:flex-row items-center justify-center gap-3 lg:gap-10" ref={butonRef}>
            ...
            {/* Email Copy Button */}
            <div
                className="flex items-center justify-center gap-2 w-[80%] sm:w-[70%] md:w-[40%] lg:w-[30%] 
                h-[3rem]  text-white/85 hover:text-white font-bold rounded-full px-4 cursor-pointer transition-colors text-center"
...
function HeroSection() {
    ...
    return (
        <>
            {/* Hero Title Section */}
            <div className="w-full font-bold text-2xl z-20 sm:text-4xl lg:text-6xl mt-20  md:text-3xl text-center h-[15vh] lg:h-[25vh] md:h-[20vh]  flex items-end text-white" >
                <div className="mx-auto textMain " ref={textRef}>
                    <h2>
                        I help founders turn ideas <br />
                        into seamless{' '} <span className="inline  glow-text poetsen-one-regular italic  ">digital experiences</span>
                    </h2>
                </div>
            </div>
