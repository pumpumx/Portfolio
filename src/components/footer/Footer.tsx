        ...
        <div className="w-full h-[100vh] bg-black z-10 overflow-x-hidden shadow-[0px_0px_800px_50px_black] ">
            <div className="w-full flex flex-col justify-center items-center h-[70vh] bg-cover bg-[url(/FooterBg.jpg)]">
                ...
                <div className="OtherText mt-10">
                    ...
                    <span>
                        <p className="text-xs text-white/70 text-center lg:text-2xl">I thrive on crafting dynamic web applications, and <br />
            ...
            <div className="w-full h-[30vh] flex shadow-[20px_0px_800px_50px_black] ">
                <div className="aboutDiv w-[50%] flex flex-col justify-center items-center">
                    ...
                    <div className="text w-[50%]">
                        <p className="text-xs font-normal text-white text-center lg:text-lg ">I'm Naaz Manhas - a full stack web developer,
                ...
                <div className="otherDiv w-[40%] flex items-center justify-around ">
                    <div className="w-[25%] h-full  flex flex-col justify-center gap-2 cursor-pointer  ml-2 items-center">
                        <div><p className="text-xs lg:text-xl text-white font-bold text-center">General</p></div>
                    ...
                    <div className="w-[25%] h-full flex flex-col justify-center gap-2 items-center cursor-pointer hover:underline">
                        <div><p className="text-xs text-white lg:text-xl font-bold text-center">Extra</p></div>
