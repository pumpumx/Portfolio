...
const  Badge = ({imgLink , text="React"}:buttonProp)=>{
    return(
        <button className="w-[30%] hover:scale-110 transition-all h-[50%] relative outline-none border-0  overflow-hidden flex  justify-around items-center  rounded-full">
